...
├── frontend/
│   ├── index.html                  # Homepage i selector de tipus d'usuari
│   ├── pages/
│   │   ├── candidate.html          # Portal lila per a candidats
│   │   └── company.html            # Portal verd aigua per a empreses
│   ├── css/
│   │   ├── base.css                # Tokens i components compartits
│   │   ├── home.css                # Homepage
│   │   ├── candidate.css           # Portal candidat
│   │   └── company.css             # Portal empresa
│   └── js/
│       ├── home.js                 # Traduccions de la homepage
│       ├── candidate.js            # Pujada i anàlisi del CV
│       └── company.js              # Ofertes, cursos i persistència local
...
2. `candidate.js` valida el PDF o DOCX al navegador.
...
4. En una fase posterior, `company.js` enviarà aquests formularis a una API i
